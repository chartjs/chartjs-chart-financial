...
describe('Financial controller tests', function () {
    ...
    it('Should create candlestick elements for each data item during initialization', function () {
        ...
        var meta = chart.getDatasetMeta(0);
        expect(meta.data.length).toBe(10); // 4 points created
        expect(meta.data[0] instanceof Chart.elements.Candlestick).toBe(true);
        expect(meta.data[1] instanceof Chart.elements.Candlestick).toBe(true);
        expect(meta.data[2] instanceof Chart.elements.Candlestick).toBe(true);
        expect(meta.data[3] instanceof Chart.elements.Candlestick).toBe(true);
        expect(meta.data[4] instanceof Chart.elements.Candlestick).toBe(true);
        expect(meta.data[5] instanceof Chart.elements.Candlestick).toBe(true);
        expect(meta.data[6] instanceof Chart.elements.Candlestick).toBe(true);
        expect(meta.data[7] instanceof Chart.elements.Candlestick).toBe(true);
        expect(meta.data[8] instanceof Chart.elements.Candlestick).toBe(true);
        expect(meta.data[9] instanceof Chart.elements.Candlestick).toBe(true);
    });
